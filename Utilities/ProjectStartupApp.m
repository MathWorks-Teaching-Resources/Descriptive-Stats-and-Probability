...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Position = [2 353 274 66];
            app.WelcomeTitle.Text = 'Welcome to Descriptive Statistics and Probability Distributions';
            ...
            app.Image.ImageSource = 'Binomial.png';
            ...
            app.ReviewTitle.FontSize = 18;
            app.ReviewTitle.FontWeight = 'bold';
            app.ReviewTitle.Position = [2 353 274 66];
            app.ReviewTitle.Text = 'Welcome to Descriptive Statistics and Probability Distributions';
