classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.StartUpAppUIFigure.Position = [100 100 276 488];
            ...
            app.WelcomePanel.Position = [-551 91 244 410];
            ...
            app.CoverImage.ImageSource = 'Binomial.png';
            ...
            app.FeedBackPanel.Position = [-291 91 236 409];
